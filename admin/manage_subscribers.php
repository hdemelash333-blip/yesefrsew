...
$items = $pdo->query("SELECT * FROM subscribers ORDER BY created_at DESC")->fetchAll();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Subscribers | YESEFERSEW Admin</title>
...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="manage_subscribers.php" class="active"><i class="fas fa-envelope"></i> Subscribers</a></li>
